...
public class WebServer {
	...
	public WebServer(String name, int port, String webContentFolder,
		...
		this(name, port, true, DEFAULT_SESSION_TIME_OUT_SEC, webContentFolder,
				logFolder, null);
	}

	public WebServer(String name, int port, boolean local,
			Integer sessionTimeOutSeconds, String webContentFolder,
		...
		logger.log(Level.INFO, "Web server is local:\t" + local);
